...
{name: "Céline", growths: [0.5,0.35,0.25,0.3,0.45,0.3,0.4,0.5,0.05],bases: ["Noble (Céline)",5,4,2,2,1,4,2,2,2,7,0,0],StatCap: [1,-1,2,2,-2,-1,0], InateProf: ["Tome"] },
...
const classes = [
  ...
  {name: "Noble (Céline)", growths: [0,0.05,0.1,0.05,0.05,0.05,0.1,0.2,0],UniqueClass: ["Céline"],bases: [20,5,8,5,8,3,5,4,4,4],statcaps: [56,38,37,29,41,27,35,50,11],AdvanceOrSpecial: [0], Proficiency1: ["Sword(B)", "Tome(B)"], Proficiency2: [], Proficiency3: []},
  {name: "Vidame", growths: [0.05,0.1,0.15,0.05,0.05,0.05,0.15,0.2,0],UniqueClass: ["Céline"],bases: [21,6,9,6,9,4,6,5,5,5],statcaps: [56,38,37,29,41,27,35,50,11],AdvanceOrSpecial: [1], Proficiency1: ["Sword(B)", "Tome(A)","Staff(B)"], Proficiency2: [], Proficiency3: []},
