...
{name: "Chloe", growths: [0.75,0.25,0.35,0.4,0.55,0.3,0.25,0.25,0.05],bases: ["Lance Flier",6,5,5,3,2,6,4,2,2,7,1,0],StatCap: [1,-1,2,2,-2,-1,0], InateProf: ["Lance"] },
...
{name: "Chloe", PersonalSkillName: "Fairy-Tale Folk", PersonalSkillDescription: "If a male and a female ally are adjacent within 2 spaces, unit deals +2 damage during combat."},
...
var coll = document.getElementsByClassName("collapsiblePersonal");
var i;
